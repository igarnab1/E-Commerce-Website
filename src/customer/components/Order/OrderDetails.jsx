                    ...
                    <Grid item xs={6}>
                        ...
                        <div className='flex items-center space-x-4'>
                            ...
                            <div className='space-y-2 ml-5'>
                                <p className='font-semibold'>Leriya Fashion Midi Dress | One Piece Dress | Beach Dress for Women</p>
                                <p className='space-x-5 opacity-50 text-xs font-semibold'> <span>Colour: Green</span> <span>Size: M</span> </p>
                                <p>Seller: Leriya</p>
                                <p>$1099</p>
                            </div>
                        </div>
