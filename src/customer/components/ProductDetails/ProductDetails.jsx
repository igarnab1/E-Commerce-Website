  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
                ...
                <p className='text-green-600 font-semibold'>{products.product?.dicountedPercent}% off</p>
              </div>
        ...
        {/* Rating and Reviews */}
        <section>
          <h1 className='font-semibold text-lg pb-4'>Recent Rating & Reviews</h1>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-60'>2374 Ratings</p>
                </div>
                ...
                <Box className="mt-5 space-y-3"> 
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, color:"yellowgreen"}} variant="determinate" value={25} />
                    </Grid>
                  </Grid>
